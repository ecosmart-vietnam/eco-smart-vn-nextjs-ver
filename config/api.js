...
export const ADMIN_LOGIN_API = API_SOURCE+"/users/login";
export const REFRESH_TOKEN_API = API_SOURCE+"/users/refresh";
export const ADD_POST_API = API_SOURCE+"/posts/add-post";
export const GET_POST_API = API_SOURCE+"/posts/get-post";
export const UPDATE_POST_API = API_SOURCE+"/posts/update-post";
export const DELETE_POST_API = API_SOURCE+"/posts/delete-post";
export const ADD_PRODUCT_API = API_SOURCE+"/products/add-product"
export const GET_PRODUCT_API = API_SOURCE+"/products/get-product";
export const GET_BRAND_API = API_SOURCE+"/products/get-brand";
export const DELETE_IMAGE_API = API_SOURCE+"/products/remove-image";
export const ADD_IMAGE_API = API_SOURCE+"/products/add-image";
export const UPDATE_PRODUCT_API = API_SOURCE+"/products/update-product"
